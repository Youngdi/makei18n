...
/**
 * migratedJSONWithConfig :: [Object] dirLangList, String val  => (dirLangList, val, i18nLanguageTransfer) -> Object
 * generateLangList :: ([String], String -> String, migratedJSONWithConfig) -> [Object] -> Promise [Object]
 */
exports.generateLangList = (dirLangList, i18nLanguageTransfer, migratedJSONWithConfig) => async (csvLangList) => dirLangList.reduce((acc, val) => [...acc, migratedJSONWithConfig(csvLangList, val, i18nLanguageTransfer(val))], []);
