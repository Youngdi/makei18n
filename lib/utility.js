...
exports.generateDir = async (langList, getLangPrefix, inputCSV) =>  {
...
exports.makeJSONfile = R.curryN(5, async (langList, getLangPrefix, env, outputFileName, mappingLangList) => {
...
exports.migratedJSON =  (env, inputDir, inputFileName, makeLangJSONWithEnv) => (langString, val, langPrefix) => 
   R.useWith(R.merge, [
...
/**
 * migratedJSONWithConfig :: [Object] langString, String val  => (langString, val, getLangPrefix) -> Object
 * generateLangList :: ([String], String -> String, migratedJSONWithConfig) -> [Object] -> Promise [Object]
 */
exports.generateLangList = (langList, getLangPrefix, migratedJSONWithConfig) => async (csvLangList) => langList.reduce((acc, val) => [...acc, migratedJSONWithConfig(csvLangList, val, getLangPrefix(val))], []);
